    ...
    return (
      <div onClick={this.handleEatIt}>
        ...
        >
          ...
          <span className="flexCentered">change</span>
          ...
          <div style={{ backgroundColor: 'red', height: '45px' }}>
            {this.leftButton()}
            <button className={'ReactModal__Buttons'} style={{ backgroundColor: 'red' }} onClick={this.handleAccept}>
              &nbsp;&nbsp;Ok&nbsp;&nbsp;
            </button>
          </div>
        </ReactModal>
...
export default compose(ACCEPT_SPEED, SET_SPEED)(SpeedModal)
