...
describe('Rectangle', () => {
  ...
  describe('angles', () => {
    ...
    it('#flAngle is 30 deg counterclockwise from facing', () => {
      expect(degreesEqual(rectangle.flAngle(), rectangle.facing - 30))
    })

    it('#frAngle is 30 deg clockwise from facing', () => {
      expect(degreesEqual(rectangle.frAngle(), rectangle.facing + 30))
    })

    it('#blAngle is (180 + 30) deg clockwise from facing ', () => {
      expect(degreesEqual(rectangle.blAngle(), rectangle.facing + 210))
    })

    it('#brAngle is (180 - 30) deg clockwise from facing', () => {
      expect(degreesEqual(rectangle.brAngle(), rectangle.facing + 150))
    })
  })
  ...
  describe('#move', () => {
    ...
    it('goes the correct direction', () => {
      ...
      expect(degreesEqual(actual, degrees))
    })
  })
  ...
  it('#backLeftCornerPivot', () => {
    ...
    const doubleLength = parseInt(result.flPoint().distanceTo(rectangle.flPoint()).toFixed(0))
    expect(degreesEqual(result.facing, rectangle.facing + 180))
  ...
  it('#backRightCornerPivot', () => {
    ...
    const doubleLength = parseInt(result.frPoint().distanceTo(rectangle.frPoint()).toFixed(0))
  ...
  it('#frontLeftCornerPivot', () => {
    ...
    const doubleLength = parseInt(result.blPoint().distanceTo(rectangle.blPoint()).toFixed(0))
    expect(result.facing).toEqual(rectangle.facing + 180)
    expect(doubleLength).toEqual(2 * result.length)
  })
  ...
  it('#frontRightCornerPivot', () => {
    ...
    const doubleLength = parseInt(result.brPoint().distanceTo(rectangle.brPoint()).toFixed(0))
    expect(result.facing).toEqual(rectangle.facing + 180)
    expect(doubleLength).toEqual(2 * result.length)
  })
